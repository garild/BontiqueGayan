...
SetupIconFile=D:\GitRepo\BontiqueGayane\BontiqueGayane\Instalator\BontiqueApp.ico
...
Source: ..\bin\Debug\Database.dll; DestDir: {app}; Flags: replacesameversion
...
Source: ..\bin\Debug\Database.dacpac; DestDir: {app}; Flags: replacesameversion
...
[Icons]
Name: {group}\BoutiqueShopp; Filename: {app}\BoutiqueShopp.exe; IconIndex: 0; WorkingDir: {app}; IconFilename: {app}\EMnet.exe
